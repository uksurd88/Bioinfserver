/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2009-06-09 06:37:03 +0200 (Tue, 09 Jun 2009) $
 * $Revision: 10979 $
 *
...
public class Viewer extends JmolViewer implements AtomDataServer {
  ...
  public void openDOM(Object DOMNode) {
    ...
    setStatusFileLoaded(1, "JSNode", "", getModelSetName(), getOpenFileError());
  }
  ...
  void repaint() {
    ...
    if (display == null)
      return;
    //System.out.println("applet test Viewer.java repaint()-->display.repaint() " + Thread.currentThread().getName() + " " + Thread.currentThread());
    display.repaint();
  }
  ...
  boolean isJmolParameter(String key) {
    return global.isJmolParameter(key);
  }
  ...
  void checkObjectDragged(int prevX, int prevY, int x, int y,
                          int modifiers) {
