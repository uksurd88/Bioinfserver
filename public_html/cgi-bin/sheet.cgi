...
<script language="JavaScript" src="lightbox.js"></script>
		...
		-->
				...
				<input type="button" value="Save Sheet Navigation History" id="navhistory" onClick="savehistory();"></input>
				<input type="submit" name="reset" value="Reset"></input>
				</form>
				<marquee><b style="color:#1980AF">Please use firefox browser for full functionality.</b></marquee>

				<script src="http://www.gmodules.com/ig/ifr?url=http://www.google.com/cse/api/003043464170429712521/cse/qccawfhyiuw/gadget&amp;synd=open&amp;w=885&amp;h=40&amp;title=BugPan+Search+Engine&amp;border=%23ffffff%7C3px%2C1px+solid+%23999999&amp;output=js"></script>
				<center><b style="color:Teal" id="time"><b>The Time, Date and Year</b></b></center>
				<!--<a onclick="Effect.Grow('runbug');"><b style="color:#1980AF">Show Experiment</a>
				<a onclick="Effect.Shrink('runbug');"><b style="color:#1980AF">Hide Experiment</a>
				<div id="runbug">
				<a onclick="runbugpan()"><b style="color:#1980AF">Run New Experiment</a>
				<input type="text" id="runbugpanoption" onChange="runbugpanoption()"></input></div>
				<div id="runbugpan"></div>-->
				...
				<a onclick="bugshot()"><b style="color:#1980AF">Save ScreenShot |</a>
				<a href="sheet.cgi"><b style="#1980AF">Reset Sheet |</b></a>
				<a href="http://www.htm2pdf.co.uk">Save as PDF |</a>
				<input type="text" value="filter values" id="renewbox" onChange=alert(\$("renewbox").value) > <b><input type="button" value="?" onClick="popup1()";></b></input></center>
      ...
      <!--<body onload='alert("Please use firefox for the full functioning of the BugPan Interface")'>-->
END_HTML
########################################################################################
########################################################################################
...
@files = `ls /home/ss533/public_html/cgi-bin/usersheets/*.txt`;
...
print '<div id="renew">
							<table  onMouseover="changeto(event, \'GreenYellow\')" onMouseout="changeback(event, \'#ffffff\')" onClick="selectcell(event)"  								id="sessTable" border="1" >
							<tr id="sesRow" >
