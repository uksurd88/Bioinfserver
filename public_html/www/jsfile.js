...
new Ajax.Updater("",'/cgi-bin/sheet.cgi',{
...
function savehistory() {
			...
			yn = prompt("Do you want to save your History(y/n)");
			if (yn == "y" ) {
			...
			if (yn == "n") alert("Enjoy your time "+user);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Function for saving the user queries.
var savecheck;
function savecheck() {
...
new Ajax.Request('/cgi-bin/savesheet.cgi', {
...
window.setTimeout("savedfilesreloading()",15000);
	new Ajax.Updater("userfiles",'/cgi-bin/loaduserfiles.cgi',{
	parameters:{}});
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
query=$("queryString").value;
	new Ajax.Updater('showQuery','/cgi-bin/ask3.cgi', {
...
new Ajax.Updater("renew",'/cgi-bin/filter.cgi', {
	parameters : {query:query}});
new Ajax.Updater("",'/cgi-bin/ask2.cgi', {
	parameters : {query:query}});
...
var sessionfolder=z;
var plotfile=t;
var file = '/cgi-bin/sessions2.cgi?session='+session+'&query='+query+'&sessionfolder='+sessionfolder+'';
...
var xlsfile = prompt("Please enter the your .xls filename!");
	for (var checkthis=0;checkthis<numberofRows;checkthis++){
		new Ajax.Updater("",'/cgi-bin/saveasxls.cgi',{
