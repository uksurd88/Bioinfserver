            ...
            this.context.beginPath();
                if (typeof(this.data[i]) == 'number') {
                    ...
                    if (variant == 'bar' || variant == '3d') {
                        ...
                        var corners = this.Get('chart.corners');
                        ...
                        if (this.Get('chart.labels.above')) {
                            ...
                            RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size') - 2, x + hmargin + (barWidth / 2), yPos, RGraph.number_format(this.data[i], this.Get('chart.units.pre'), this.Get('chart.units.post')), null, 'center');
                        }
                ...
                */
                    ...
                    if (this.Get('chart.labels.above')) {
                        ...
                        this.context.fillStyle = this.Get('chart.text.color');
                        RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size') - 2, startX + (barWidth / 2) + this.Get('chart.hmargin'), startY - (this.Get('chart.shadow') && this.Get('chart.shadow.offsety') < 0 ? 7 : 4), String(this.Get('chart.units.pre') + RGraph.array_sum(this.data[i]) + this.Get('chart.units.post')), null, 'center');
                ...
                */
                    ...
                    for (j=0; j<this.data[i].length; ++j) {
                        ...
                        if (this.Get('chart.labels.above')) {
                            ...
                            this.context.fillStyle = this.Get('chart.text.color');
                            RGraph.Text(this.context, this.Get('chart.text.font'), this.Get('chart.text.size') - 2, startX + (individualBarWidth / 2) , startY - 2, this.data[i][j], null, 'center');
