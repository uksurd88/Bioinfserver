    ...
    RGraph.Pie.prototype.Draw = function ()
    {
        ...
        */
        ...
        for (var i=0,len=this.data.length; i<len; i++) {
            var angle = Math.round(this.data[i] / this.total * 360, 2);
                        ...
                        if (isDonut || hStyle == '2d') {
                            ...
                            */
                            if (obj.Get('chart.border')) {
                                ...
                                context.lineWidth = 5;
                                context.arc(this.centerx - 3, this.centery - 3, obj.radius - 2, RGraph.degrees2Radians(obj.angles[i][0]), RGraph.degrees2Radians(obj.angles[i][1]), 0);
                                context.stroke();
                            }
                        }
    ...
    */
    RGraph.Pie.prototype.DrawSegment = function (degrees, color, last)
    {
        ...
        context.beginPath();
            ...
            context.lineWidth   = this.Get('chart.linewidth');
